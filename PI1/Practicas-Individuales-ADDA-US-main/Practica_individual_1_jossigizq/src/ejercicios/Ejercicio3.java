...
//		}
	...
	private static List<Punto2D> solucion_recursiva_final_aux(Iterator<String> it1, Iterator<String> it2, Punto2D p1, Punto2D p2, List<Punto2D> res){
...
//		List<Punto2D> lista1 = Stream2.file(file1)
//				.map(linea -> Punto2D.parse(linea))
//				.filter(p -> p.getCuadrante() == Cuadrante.PRIMER_CUADRANTE || p.getCuadrante() == Cuadrante.TERCER_CUADRANTE)
//				.collect(Collectors.toList());
//		
//		List<Punto2D> lista2 = Stream2.file(file2)
//				.map(linea -> Punto2D.parse(linea))
//				.filter(p -> p.getCuadrante() == Cuadrante.PRIMER_CUADRANTE || p.getCuadrante() == Cuadrante.TERCER_CUADRANTE)
//				.collect(Collectors.toList());
		
//		Stream<String> st1 = Files.lines(Path.of(file1));
//		Stream<String> st2 = Files.lines(Path.of(file2));
//		
//		Stream<String> st3 = Stream.of();
